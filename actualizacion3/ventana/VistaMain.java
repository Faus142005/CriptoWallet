...
public class VistaMain extends JFrame implements Runnable{
	...
	public VistaMain() {
		...
		controladores.add(registrarseControlador);
		controladores.add(ingresarControlador);
		controladores.add(inicioControlador);
		controladores.add(cotizacionesCriptomonedasControlador);
		controladores.add(compraCriptomonedaControlador);
		controladores.add(visualizarActivosControlador);
		controladores.add(transaccionesControlador);
	...
	public void cambiarPanel(String id) {
		...
		for(CriptoWalletControlador cc : controladores)
			cc.actualizar(null);
