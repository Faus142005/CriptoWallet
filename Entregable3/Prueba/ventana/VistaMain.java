...
import ventana.compraCriptomoneda.CompraCriptomonedaModelo;
...
public class VistaMain extends JFrame {
	...
	private CompraCriptomonedaModelo compraCriptomonedaModelo = new CompraCriptomonedaModelo();
	...
	private CompraCriptomonedaControlador compraCriptomonedaControlador = new CompraCriptomonedaControlador(compraCriptomonedaVista, compraCriptomonedaModelo);
	...
	public VistaMain() {
		...
		cardPanel.add(compraCriptomonedaVista.getPanel(), "Compra de Criptomoneda");

		cardLayout.show(cardPanel, "Compra de Criptomoneda");
		this.setTitle("CriptoWallet - " + "Compra de Criptomoneda");
		this.setSize(compraCriptomonedaVista.getDimensiones());
