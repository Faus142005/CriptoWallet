...
public class FuncionesDeLaAplicacion {
	...
	private static void restarStockCriptoBD(Stock stockCripto, UnidadDeCompra unidadDeCompra, StockDAO<Stock> stockDAO)
		...
		// Si no, ya estaba creado, y ahora me fijo si alcanza la cantidad de stock de
		// cripto actual
	...
	public static Transaccion comprarCriptomoneda(UnidadDeCompra unidadDeCompra) throws StockInsuficienteException, FondosInsuficientesException  {
