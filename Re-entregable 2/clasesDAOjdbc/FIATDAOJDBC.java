...
public class FIATDAOJDBC implements FIATDAO<FIAT> {
	...
	@Override
	public void insertarFIAT( FIAT f, Stock stock) throws SQLException {
	...
	@Override
	public void actualizarFIAT( FIAT c, Stock stock) throws SQLException {
	...
	@Override
	public void eliminarFIAT( String nomenclatura) throws SQLException {
