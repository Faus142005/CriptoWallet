...
public class TransaccionRecepcion extends Transaccion {
	...
	public TransaccionRecepcion(double cantidad, double comision, String codigoDeTransaccion, Moneda moneda, String resumen,
			String codigoOrigen) {
	...
	public String toString() {
		...
		return "Has recibido " + this.getCantidad() + " " + this.getMoneda().getNombre() + " de " + codigoOrigen
				+ ". Comision del emisor " + this.getComision() + ". Fecha " + this.getFecha_hora().toString()
