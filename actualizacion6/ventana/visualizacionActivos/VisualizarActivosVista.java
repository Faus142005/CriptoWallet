...
public class VisualizarActivosVista {
	...
	public void nuevosActivos() {
		...
		for (ActivoCripto activoCripto : activosCripto) {
			...
			// Redondeamos el valor del monto a dos decimales
            String aux = String.format("%.2f", activoCripto.getCantidad() * criptomoneda.getValorDolar());
			JLabel extraLabel2 = new JLabel(
					"Monto total en USD: " + aux);
			gbc.gridy = 1;
		...
		for (ActivoFIAT activoFIAT : activosFIAT) {
			...
			// Redondeamos el valor del monto a dos decimales
            String aux = String.format("%.2f", activoFIAT.getCantidad() * fiat.getValorDolar());
			JLabel extraLabel2 = new JLabel("Monto total en USD: " + aux);
			gbc.gridy = 1;
			extraLabel2.setHorizontalAlignment(SwingConstants.CENTER);
			informacionActivo.add(extraLabel2, gbc);
