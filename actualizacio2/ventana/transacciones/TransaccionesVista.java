...
public class TransaccionesVista implements CriptoWalletControlador {
	...
	public void actualizarTransferencias() {
		...
		List<Transaccion> transacciones = FuncionesDeLaAplicacion.listarTransacciones(GestorDeDatosDeLaAplicacion.getUsuarioConectado());
		...
		for (Transaccion transaccion : transacciones) {
		    ...
		    panelScrollPaneTransferencias.add(Box.createVerticalStrut(10));
		}
	}

	@Override
	public void actualizar(IdActualizacion id) {
		if (id == IdActualizacion.ActualizacionTransferencias) {
