...
public class FuncionesDeCreacionDeMonedasYStock {
	...
	public static void crearMonedas() {
		try {
			...
			// Criptomonedas
			c = new Criptomoneda(-1, "Bitcoin", "BTC", 0, "resources/Bitcoin.png", 1);
			...
			c = new Criptomoneda(-1, "Etherium", "ETH", 0, "resources/Etherium.png", 1);
			if (monedaDAO.buscarCriptomoneda(c.getNomenclatura()) == null) {
				c.setIdMoneda(monedaDAO.insertarCriptomoneda(c));
				stockDAO.insertarStock(new Stock(-1, c, 0));
			}

			c = new Criptomoneda(-1, "USD-COIN", "USDC", 0, "resources/USD-COIN.png", 1);
			if (monedaDAO.buscarCriptomoneda(c.getNomenclatura()) == null) {
				c.setIdMoneda(monedaDAO.insertarCriptomoneda(c));
				stockDAO.insertarStock(new Stock(-1, c, 0));
			}

			c = new Criptomoneda(-1, "Tether", "USDT", 0, "resources/Tether.png", 1);
			if (monedaDAO.buscarCriptomoneda(c.getNomenclatura()) == null) {
				c.setIdMoneda(monedaDAO.insertarCriptomoneda(c));
				stockDAO.insertarStock(new Stock(-1, c, 0));
			}

			c = new Criptomoneda(-1, "DogeCoin", "DOGE", 0, "resources/DogeCoin.png", 1);
			if (monedaDAO.buscarCriptomoneda(c.getNomenclatura()) == null) {
				c.setIdMoneda(monedaDAO.insertarCriptomoneda(c));
				stockDAO.insertarStock(new Stock(-1, c, 0));
			}
			...
			f = new FIAT(-1, "Dolar", "USD", 1, "resources/Dolar.png");
			...
			f = new FIAT(-1, "Peso Argentino", "ARS", 0.001, "resources/PesoArgentino.png");
			if (monedaDAO.buscarFIAT(f.getNomenclatura()) == null) {
				c.setIdMoneda(monedaDAO.insertarFIAT(f));
				stockDAO.insertarStock(new Stock(-1, f, 0));
			}

			f = new FIAT(-1, "Euro", "EUR", 1.05, "resources/Euro.png");
			if (monedaDAO.buscarFIAT(f.getNomenclatura()) == null) {
				c.setIdMoneda(monedaDAO.insertarFIAT(f));
				stockDAO.insertarStock(new Stock(-1, f, 0));
			}
